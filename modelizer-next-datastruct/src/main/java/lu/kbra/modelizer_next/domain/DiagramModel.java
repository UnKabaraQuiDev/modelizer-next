...
public class DiagramModel implements PostConstructOwner, PreDeconstructOwner {
	...
	private final transient Map<String, ClassModel> classById = new HashMap<>();
	private final transient Map<String, LinkModel> conceptualLinkById = new HashMap<>();
	private final transient Map<String, LinkModel> technicalLinkById = new HashMap<>();
	private final transient Map<String, CommentModel> commentById = new HashMap<>();
	private final transient Map<String, LinkModel> linkByAssociationClassId = new HashMap<>();
	private final transient Map<String, LinkModel> linkById = new HashMap<>();
	private final transient Map<PanelType, Set<ClassModel>> classesByPanel = new EnumMap<>(PanelType.class);
