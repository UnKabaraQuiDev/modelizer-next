...
@Getter
public class WebpImageModelVisitor implements ModelVisitor {
	...
	public WebpImageModelVisitor(final ImageOptionsManager optionsManager, final ImageExporterOptions pclibOptions) {
	...
	public void visitDocument(final ModelDocument file, final ExportUpdateCallback callback) throws ExportFailedException {
		ImageModelVisitor
				.export(file, this.optionsManager, this.options, callback, WebpImageModelVisitor.format, this.options.getExtension());
	}
