...
@Getter
public class TifImageExporter implements ImageModelExporter {

	public static final String EXPORTER_ID = "png";

	private final UiProvider uiProvider = new TifImageUiProvider();
	private final ImageOptionsManager optionsManager = new TifImageOptionsManager();
	...
	public ModelVisitor buildModelVisitor(final ExporterOptions options) {
		...
		return new TifImageModelVisitor(this.optionsManager, pngOptions);
	}
	...
	public String getExporterId() {
		return TifImageExporter.EXPORTER_ID;
	}
