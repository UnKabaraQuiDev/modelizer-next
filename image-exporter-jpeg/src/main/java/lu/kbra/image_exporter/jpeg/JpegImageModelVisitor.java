...
@Getter
public class JpegImageModelVisitor implements ModelVisitor {
	...
	public JpegImageModelVisitor(final ImageOptionsManager optionsManager, final ImageExporterOptions pclibOptions) {
	...
	public void visitDocument(final ModelDocument file, final ExportUpdateCallback callback) throws ExportFailedException {
		ImageModelVisitor
				.export(file, this.optionsManager, this.options, callback, JpegImageModelVisitor.format, this.options.getExtension());
	}
