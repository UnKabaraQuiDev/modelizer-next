...
/**
 * Parsed command-line export request. It groups the input pattern, export type, output destination, view scope,
 * file naming pattern, overwrite flag, and glob behavior.
