...
//		buttons.addSeparator();
		...
		final TransferHandler fileDropHandler = new TransferHandler() {
			...
			public boolean importData(final TransferSupport support) {
				...
				try {
					...
					JOptionPane.showMessageDialog(MainFrame.this, "No supported file could be loaded.", "Drop error",
							JOptionPane.WARNING_MESSAGE);
					return false;
				} catch (final Exception ex) {
					JOptionPane.showMessageDialog(MainFrame.this, "Failed to load dropped file:\n" + ex.getMessage(),
	...
	private void loadDocument() {
		...
		if (!this.loadDocument(chooser.getSelectedFile())) {
			JOptionPane.showMessageDialog(this, "Failed to load document:\n" + chooser.getSelectedFile().getPath(),
