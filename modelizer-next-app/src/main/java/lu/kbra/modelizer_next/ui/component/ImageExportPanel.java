...
public class ImageExportPanel extends JPanel {
	...
	private JCheckBox chckbxConceptual;

	private JCheckBox chckbxLogical;
	...
	public ImageExportPanel() {
		...
		gbc_txtfilenamepanel.gridwidth = 2;
		gbc_txtfilenamepanel.insets = new Insets(0, 0, 5, 5);
		gbc_txtfilenamepanel.fill = GridBagConstraints.HORIZONTAL;
